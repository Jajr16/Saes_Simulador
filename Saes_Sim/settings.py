"""
Django settings for Saes_Sim project.
...
import cloudinary
cloudinary.config(
    cloud_name = 'dwaxhi9xm',
    api_key = '928418719128129',
    api_secret = 'bBWCa3w9TROcsMF5z272_1e05IA'
)
...
SECRET_KEY = 'django-insecure-&!6#=i0a=vb##gvx5848w=0gcmrv2cnp*=j%yncwmx#wx8e071'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'website.control_cargos.rol_cargo_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'Saes_Sim.wsgi.application'
